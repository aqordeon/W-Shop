...
<div id="frame-faktur">
    ...
    <div id="frame-keterangan-pembayaran">
        ...
        Nomor Account: 2345-8449-3576 [A/N Vika Aqordead]<br/>
        Setelah melakukan pembayaran silahkan lakukan pembayaran <a href="<?php echo BASE_URL.'index.php?page=my_profile&module=pesanan&action=konfirmasi_pembayaran&pesanan_id='.$pesanan_id; ?>">Disini</a>
        </p>
